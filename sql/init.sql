...
) ENGINE = InnoDB AUTO_INCREMENT = 2171 COMMENT = '数据历史表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 5126 COMMENT = '文件表; 软删除未启用;';
...
INSERT INTO `_ui` (`id`,`pageId`,`uiActionType`,`uiActionId`,`desc`,`uiActionConfig`,`appDataSchema`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (17,'doUiActionComponent','ui','deleteItem','✅删除数据','{\"before\":[{\"vueComponent\":\"jhConfirmDialog\",\"function\":\"confirmDialog\",\"functionParamObj\":{\"title\":\"删除\",\"content\":\"确定删除吗？\"}}],\"main\":[{\"function\":\"prepareItemData\"},{\"function\":\"doDeleteItem\"}],\"after\":[{\"function\":\"refreshTableData\"},{\"function\":\"computedTableData\"}]}',NULL,'update','vscode','vscode','2022-09-09T15:10:15+08:00');
...
INSERT INTO `_ui` (`id`,`pageId`,`uiActionType`,`uiActionId`,`desc`,`uiActionConfig`,`appDataSchema`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (56,'doUiActionComponent','ui','computedTableData','✅处理数据','{ \"main\": [{\"function\": \"computedTableData\"}] }',NULL,'update','vscode','vscode','2022-09-09T15:10:15+08:00');
...
INSERT INTO `_user_group_role_resource` (`id`, `user`, `group`, `role`, `resource`, `allowOrDeny`, `desc`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (2, '*', 'login', '*', 'allPage.*', 'allow', '所有权限, 开放给所有登陆成功的用户', 'insert', NULL, NULL, NULL);
INSERT INTO `_user_group_role_resource` (`id`, `user`, `group`, `role`, `resource`, `allowOrDeny`, `desc`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (3, '*', 'login', '*', '*', 'allow', '所有权限, 开放给所有登陆成功的用户', 'insert', NULL, NULL, NULL);
